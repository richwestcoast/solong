...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/01 14:02:47 by rwinder           #+#    #+#             */
/*   Updated: 2023/09/04 13:30:49 by rwinder          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*read2left_str(int fd, char *left_str)
{
	...
	while (!gnlft_strchr(left_str, '\n') && readbytes != 0)
	{
		...
		buff[readbytes] = '\0';
		left_str = gnlft_strjoin(left_str, buff);
...
char	*ft_new_left_str(char *left_str)
{
	...
	str = (char *) malloc(sizeof(char) * (gnlft_strlen (left_str) - i + 1));
	if (!str)
		return (NULL);
	i++;
	j = 0;
